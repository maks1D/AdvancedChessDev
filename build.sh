...
clang obj/main.o obj/base64.o obj/captcha.o obj/chess.o obj/configuration.o obj/database.o obj/endianness.o obj/filesystem.o obj/hasher.o obj/server.o -o AdvancedChess